...
//      $ opt --legacy-fnargusage -analyze input_for_fnargusage.ll
//
// EXAMPLE OUTPUT:
...
void initializeLegacyFunctionArgumentUsagePassPass(PassRegistry &);

} // end llvm namespace

INITIALIZE_PASS(LegacyFunctionArgumentUsagePass, "legacy-fnargusage",
                "Function Argument Usage Pass",
...
// Helper functions
//-----------------------------------------------------------------------------
void llvmexp::printTypeMismatches(llvm::raw_ostream &OS,
